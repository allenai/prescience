"""Plot LACER diversity time series from scored neighbor data."""
import os
import random
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Plot LACER diversity time series.")
    ...
    parser.add_argument("--output_path", type=str, default="figures/multiturn/lacer_diversity.png", help="Output figure path")
