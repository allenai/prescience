"""Temporal extrapolation baseline for topic-pair growth prediction (causally safe).

Per-pair linear fit on history_monthly_counts; extrapolates forward for |F| months and sums.
